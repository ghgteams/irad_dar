...
public class PedestrianNewEntity {
	...
	public PedestrianNewEntity(long id, String acc_id, String pedestrian_ref_id, String patient_disposition,
			String veh_no, String marital_status, String employed_or_not, String name_add_employer, String income,
			String assessed_to_income_tax, String reimbursement_medical_expense, String cashless_treatment,
			String loss_to_property, String value_of_loss, String additional_info, String relief_amount,
			...
			String periodHospitlization, String treatmentDetails, String injury_type) {
		super();
		this.id = id;
		this.acc_id = acc_id;
		this.pedestrian_ref_id = pedestrian_ref_id;
	...
	public String toString() {
		return "PedestrianNewEntity [id=" + id + ", acc_id=" + acc_id + ", pedestrian_ref_id=" + pedestrian_ref_id
				+ ", patient_disposition=" + patient_disposition + ", veh_no=" + veh_no + ", marital_status="
				+ marital_status + ", employed_or_not=" + employed_or_not + ", name_add_employer=" + name_add_employer
				+ ", income=" + income + ", assessed_to_income_tax=" + assessed_to_income_tax
				+ ", reimbursement_medical_expense=" + reimbursement_medical_expense + ", cashless_treatment="
				+ cashless_treatment + ", loss_to_property=" + loss_to_property + ", value_of_loss=" + value_of_loss
				+ ", additional_info=" + additional_info + ", relief_amount=" + relief_amount + ", sole_earning_member="
				...
				+ ", periodHospitlization=" + periodHospitlization + ", treatmentDetails=" + treatmentDetails
				+ ", injury_type=" + injury_type + "]";
	}

	public PedestrianNewEntity() {
		super();
