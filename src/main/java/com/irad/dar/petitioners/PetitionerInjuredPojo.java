...
public class PetitionerInjuredPojo {
	...
	public String toString() {
		return "PetitionerInjuredPojo [accidentId=" + accidentId + ", vehicleId=" + vehicleId + ", personId=" + personId
				+ ", personType=" + personType + ", injTreatment=" + injTreatment + ", injConvenance=" + injConvenance
				+ ", injSpecialDiet=" + injSpecialDiet + ", injCostNursingAttend=" + injCostNursingAttend
				+ ", injLossIncome=" + injLossIncome + ", injCostArtificialLimp=" + injCostArtificialLimp
				+ ", injAnotherLoss=" + injAnotherLoss + ", injPhyShock=" + injPhyShock + ", injPainSuffer="
				+ injPainSuffer + ", lossAmenities=" + lossAmenities + ", injDisfiguration=" + injDisfiguration
				+ ", injLossOfMarriage=" + injLossOfMarriage + ", injLossHarDis=" + injLossHarDis + ", injDisability="
				+ injDisability + ", injLifeSpan=" + injLifeSpan + ", injLossEarning=" + injLossEarning
				+ ", injLossFutureIncome=" + injLossFutureIncome + ", injTotalCompensation=" + injTotalCompensation
				+ ", injInterest=" + injInterest + "]";
	}
	public PetitionerInjuredPojo(String accidentId, String vehicleId, String personId, String personType,
			...
			String injLossFutureIncome, String injTotalCompensation, String injInterest) {
		super();
		this.accidentId = accidentId;
		this.vehicleId = vehicleId;
		this.personId = personId;
