...
public class PDFController {
	...
	public ResponseEntity<?> getMinorChildrendataView(@RequestParam String accid, String whoseChild, String user_type,
		...
		String fileName = accid.concat("_").concat("Form3").concat("_").concat("Child").concat(".pdf");
		...
		List<MinorChildrenDetailsEntity1> minorChildrenDetailsEntity = service.getMinorChildrendata(whoseChild,
				user_type, accid);
	...
	public ResponseEntity<?> getPDF7View(@RequestParam String accidentId, String vehicleId, String refId, String mode,
			HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		Pdf7Entity accident = service.getreport7(accidentId, vehicleId, refId, mode);
		String fileName = accidentId.concat("_").concat("Form3").concat("_").concat(accident.getVehRegNo())
				.concat(".pdf");
	...
	public ResponseEntity<?> getPDF10View(@RequestParam String accidentId, String vehicleRegNo,
		...
		WebContext context = new WebContext(request, response, servletContext);
		context.setVariable("accidentEntry", vehicleDetailsEntity);
	...
	public ResponseEntity<?> getPDF11View(@RequestParam String accidentId, String vehicleId, String mode,
		...
		WebContext context = new WebContext(request, response, servletContext);
		context.setVariable("pdf11Entity", pdf11Entity);
		...
		HtmlConverter.convertToPdf(orderHtml, target, converterProperties);
		byte[] bytes = target.toByteArray();
		return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=form11.pdf")
				.contentType(MediaType.APPLICATION_PDF).body(bytes);
	}
	...
	public ResponseEntity<?> getPDF13View(@RequestParam String accidentId, String vehicleId, String personId,
		...
		// AccidentDetails accident=service.getreport10(accidentId,vehicleRegNo);
		WebContext context = new WebContext(request, response, servletContext);
		context.setVariable("pdf13Entity", pdf13Entity);
	...
	public ResponseEntity<?> getPDF14View(@RequestParam String accidentId, String vehicleId, String personId,
		...
		// AccidentDetails accident=service.getreport10(accidentId,vehicleRegNo);
		WebContext context = new WebContext(request, response, servletContext);
		context.setVariable("pdf14Entity", pdf14Entity);
	...
	public ResponseEntity<?> getPDF15View(@RequestParam String accidentId, String vehicleId, String personId,
		...
		WebContext context = new WebContext(request, response, servletContext);
		context.setVariable("pdf15Entity", pdf15Entity);
