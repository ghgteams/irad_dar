...
public class Pdf9Entity {
	...
	private String veh_horn_functional;
	...
	public String getMvi_regno() {
		return mvi_regno;
	}
	public void setMvi_regno(String mvi_regno) {
		this.mvi_regno = mvi_regno;
	}
	...
	public String getEducationalVehicle() {
		return educationalVehicle;
	}
	public void setEducationalVehicle(String educationalVehicle) {
		this.educationalVehicle = educationalVehicle;
	}
	...
	public String getLocationScratch() {
		return locationScratch;
	}
	public void setLocationScratch(String locationScratch) {
		this.locationScratch = locationScratch;
	}
	public String getVeh_horn_functional() {
		return veh_horn_functional;
	}
	public void setVeh_horn_functional(String veh_horn_functional) {
		this.veh_horn_functional = veh_horn_functional;
	}
	public Pdf9Entity(String currentDate, String accidentId, String firNumber, String dateTime, String timeOfTheDay,
			String psName, String landmarks, String section, String state, String district, String mvi_req_dt,
			String mvi_name, String mvi_regno, String vehicle_reg_no, String vehicleType, String vehicleMake,
			String vehicleModel, String color, String engineno, String chassisno, String fitcertval, String permitno,
			String permitvalidity, String veh_paint_transfer, String veh_color_paint_transfer,
			String veh_location_paint_transfer1, String veh_type_scratch, String veh_steer_cond, String veh_wheel_cond,
			String veh_wiper_cond, String veh_mirror_cond, String veh_cng_kit, String veh_tyre_condition,
			String veh_horn_installed, String veh_horn_functional, String veh_brake_lights_functional,
			String veh_faulty_no_plate, String veh_fitted_airbags, String veh_airbags_deployed, String veh_tinted_glass,
			String veh_speed_limiter, String veh_speed_limiter_functional, String veh_rear_parkingsensor,
			String veh_rear_parkingsensor_works, String veh_tracking_devices, String veh_tracking_devices_works,
			String veh_description_damage, String veh_location_inspection, String veh_change_veh_body,
			String pointOfImpact, String locationScratch, String act, String firDateTime, String shoName,
			String shoDesignation, String educationalVehicle) {
		super();
		this.currentDate = currentDate;
		this.accidentId = accidentId;
		this.firNumber = firNumber;
	...
	public String toString() {
		return "Pdf9Entity [currentDate=" + currentDate + ", accidentId=" + accidentId + ", firNumber=" + firNumber
				+ ", dateTime=" + dateTime + ", timeOfTheDay=" + timeOfTheDay + ", psName=" + psName + ", landmarks="
				+ landmarks + ", section=" + section + ", state=" + state + ", district=" + district + ", mvi_req_dt="
				+ mvi_req_dt + ", mvi_name=" + mvi_name + ", mvi_regno=" + mvi_regno + ", vehicle_reg_no="
				+ vehicle_reg_no + ", vehicleType=" + vehicleType + ", vehicleMake=" + vehicleMake + ", vehicleModel="
				+ vehicleModel + ", color=" + color + ", engineno=" + engineno + ", chassisno=" + chassisno
				+ ", fitcertval=" + fitcertval + ", permitno=" + permitno + ", permitvalidity=" + permitvalidity
				+ ", veh_paint_transfer=" + veh_paint_transfer + ", veh_color_paint_transfer="
				+ veh_color_paint_transfer + ", veh_location_paint_transfer1=" + veh_location_paint_transfer1
				+ ", veh_type_scratch=" + veh_type_scratch + ", veh_steer_cond=" + veh_steer_cond + ", veh_wheel_cond="
				+ veh_wheel_cond + ", veh_wiper_cond=" + veh_wiper_cond + ", veh_mirror_cond=" + veh_mirror_cond
				+ ", veh_cng_kit=" + veh_cng_kit + ", veh_tyre_condition=" + veh_tyre_condition
				+ ", veh_horn_installed=" + veh_horn_installed + ", veh_horn_functional=" + veh_horn_functional
				+ ", veh_brake_lights_functional=" + veh_brake_lights_functional + ", veh_faulty_no_plate="
				+ veh_faulty_no_plate + ", veh_fitted_airbags=" + veh_fitted_airbags + ", veh_airbags_deployed="
				+ veh_airbags_deployed + ", veh_tinted_glass=" + veh_tinted_glass + ", veh_speed_limiter="
				+ veh_speed_limiter + ", veh_speed_limiter_functional=" + veh_speed_limiter_functional
				+ ", veh_rear_parkingsensor=" + veh_rear_parkingsensor + ", veh_rear_parkingsensor_works="
				+ veh_rear_parkingsensor_works + ", veh_tracking_devices=" + veh_tracking_devices
				+ ", veh_tracking_devices_works=" + veh_tracking_devices_works + ", veh_description_damage="
				+ veh_description_damage + ", veh_location_inspection=" + veh_location_inspection
				+ ", veh_change_veh_body=" + veh_change_veh_body + ", pointOfImpact=" + pointOfImpact
				+ ", locationScratch=" + locationScratch + ", act=" + act + ", firDateTime=" + firDateTime
				+ ", shoName=" + shoName + ", shoDesignation=" + shoDesignation + ", educationalVehicle="
				+ educationalVehicle + "]";
	}
	public Pdf9Entity() {
		super();
