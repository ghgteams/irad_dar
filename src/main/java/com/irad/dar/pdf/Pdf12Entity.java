...
public String toString() {
	return "Pdf12Entity [accidentId=" + accidentId + ", firNo=" + firNo + ", accidentDate=" + accidentDate
			...
			+ ", emotionalHarm=" + emotionalHarm + ", damageLossProperty=" + damageLossProperty + ", anyOtherLoss="
			+ anyOtherLoss + ", physicalHarm=" + physicalHarm + "]";
}
public Pdf12Entity(String accidentId, String firNo, String accidentDate, String section, String policeStationName,
		...
		String injuredmovableasset, String injuredimmovableasset, String injuredrecommendation, String emotionalHarm,
		String damageLossProperty, String anyOtherLoss, String physicalHarm) {
	super();
	this.accidentId = accidentId;
	this.firNo = firNo;
	this.accidentDate = accidentDate;
