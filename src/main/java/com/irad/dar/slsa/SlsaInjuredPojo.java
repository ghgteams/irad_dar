...
public class SlsaInjuredPojo {
	...
	private String inj_details_of_surgeries;
	...
	public String getInj_details_of_surgeries() {
		return inj_details_of_surgeries;
	}
	public void setInj_details_of_surgeries(String inj_details_of_surgeries) {
		this.inj_details_of_surgeries = inj_details_of_surgeries;
	}
	...
	public SlsaInjuredPojo(long id, String accident_id, String person_id, String person_type, String vehicle_id,
			long id_insurance, String inj_permenant_disablity, String inj_treatment, String inj_convenance,
			...
			String inj_loss_ear_inc_har_dis, String inj_name_of_hospital, String inj_details_of_surgeries,
			String inj_got_reimpuresement, String inj_treatment_still_continuing,
			String inj_any_other_loss_req_special_treatment, String inj_percentage_disablity,
			String inj_loss_of_future_income, String inj_any_other_pecuniary_loss, String inj_total_copensation) {
		super();
		this.id = id;
		this.accident_id = accident_id;
		this.person_id = person_id;
