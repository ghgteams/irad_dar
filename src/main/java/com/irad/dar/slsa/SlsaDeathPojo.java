...
public class SlsaDeathPojo {
	...
	public String toString() {
		return "SlsaDeathPojo [id=" + id + ", id_slsa=" + id_slsa + ", accident_id=" + accident_id + ", person_id="
				...
				+ ", death_any_other_pecuniary=" + death_any_other_pecuniary + ", death_emotional_harm_etc="
				+ death_emotional_harm_etc + ", death_post_traumatic_stress_disorder="
				+ death_post_traumatic_stress_disorder + ", death_any_other_nonpecuniary="
				+ death_any_other_nonpecuniary + ", vehicle_id=" + vehicle_id + "]";
	}
	public SlsaDeathPojo(long id, long id_slsa, String accident_id, String person_id, String person_type,
			...
			String death_total_compensation, String death_any_other_pecuniary, String death_emotional_harm_etc,
			String death_post_traumatic_stress_disorder, String death_any_other_nonpecuniary, String vehicle_id) {
		super();
		this.id = id;
		this.id_slsa = id_slsa;
		this.accident_id = accident_id;
