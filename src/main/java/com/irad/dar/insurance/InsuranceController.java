...
public class InsuranceController {
	...
	public JSONObject saveInsuranceInjured(@RequestBody InsuranceInjuredPojo insuranceInjuredPojo)throws Exception {
		...
		insuranceInjuredEntity.setTreatmentInj(insuranceInjuredPojo.getInj_medical_treatment());
		insuranceInjuredEntity.setInj_medical_treatment(insuranceInjuredPojo.getInj_medical_treatment());
		insuranceInjuredEntity.setInj_loss_erning_capacity(insuranceInjuredPojo.getInj_loss_erning_capacity());
...
//		insuranceInjuredEntity.setInj_loss_erning_capacity(insuranceInjuredPojo.getInj_loss_erning_capacity());
		...
		insuranceInjuredEntity.setExpenditureTreatmentInj(insuranceInjuredPojo.getInj_expenditure_treatment());
		insuranceInjuredEntity.setPermenantDisabilityDetailsInj(insuranceInjuredPojo.getInj_permenant_disablity_details());
