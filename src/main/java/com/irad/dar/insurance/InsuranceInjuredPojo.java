...
public class InsuranceInjuredPojo {
	...
	private String inj_disfiguration;
	private String inj_medical_treatment;
	private String inj_loss_of_marriage;
	
	private String inj_natureofinjury;
	private String inj_typeofinjury;
	private String inj_expenditure_treatment;
	private String inj_permenant_disablity_details;
	...
	public String getInj_disfiguration() {
		return inj_disfiguration;
	}
	public void setInj_disfiguration(String inj_disfiguration) {
		this.inj_disfiguration = inj_disfiguration;
	}
	...
	public String getInj_loss_of_marriage() {
		return inj_loss_of_marriage;
	}
	public void setInj_loss_of_marriage(String inj_loss_of_marriage) {
		this.inj_loss_of_marriage = inj_loss_of_marriage;
	}
	public String getInj_natureofinjury() {
		return inj_natureofinjury;
	}
	public void setInj_natureofinjury(String inj_natureofinjury) {
		this.inj_natureofinjury = inj_natureofinjury;
	}
	public String getInj_typeofinjury() {
		return inj_typeofinjury;
	}
	public void setInj_typeofinjury(String inj_typeofinjury) {
		this.inj_typeofinjury = inj_typeofinjury;
	}
	public String getInj_expenditure_treatment() {
		return inj_expenditure_treatment;
	}
	public void setInj_expenditure_treatment(String inj_expenditure_treatment) {
		this.inj_expenditure_treatment = inj_expenditure_treatment;
	}
	public String getInj_permenant_disablity_details() {
		return inj_permenant_disablity_details;
	}
	public void setInj_permenant_disablity_details(String inj_permenant_disablity_details) {
		this.inj_permenant_disablity_details = inj_permenant_disablity_details;
	}
	...
	public String toString() {
		return "InsuranceInjuredPojo [id_insurance=" + id_insurance + ", vehicle_id=" + vehicle_id + ", accident_id="
				+ accident_id + ", person_id=" + person_id + ", person_type=" + person_type
				+ ", inj_permenant_disablity=" + inj_permenant_disablity + ", inj_treatment=" + inj_treatment
				+ ", inj_convenance=" + inj_convenance + ", inj_special_diet=" + inj_special_diet
				+ ", inj_cost_nursing_attendant=" + inj_cost_nursing_attendant + ", inj_cost_artificial_limp="
				+ inj_cost_artificial_limp + ", inj_loss_erning_capacity=" + inj_loss_erning_capacity
				+ ", inj_loss_income=" + inj_loss_income + ", inj_any_other_loss=" + inj_any_other_loss
				+ ", inj_com_mental_phy_shock=" + inj_com_mental_phy_shock + ", inj_pain_suffering="
				+ inj_pain_suffering + ", inj_loss_amenities=" + inj_loss_amenities + ", inj_loss_ear_inc_har_dis="
				+ inj_loss_ear_inc_har_dis + ", inj_total_copensation=" + inj_total_copensation + ", inj_disfiguration="
				+ inj_disfiguration + ", inj_medical_treatment=" + inj_medical_treatment + ", inj_loss_of_marriage="
				+ inj_loss_of_marriage + ", inj_natureofinjury=" + inj_natureofinjury + ", inj_typeofinjury="
				+ inj_typeofinjury + ", inj_expenditure_treatment=" + inj_expenditure_treatment
				+ ", inj_permenant_disablity_details=" + inj_permenant_disablity_details + ", token=" + token
				+ ", inj_income=" + inj_income + ", version=" + version + "]";
	}
	public InsuranceInjuredPojo(int id_insurance, String vehicle_id, String accident_id, String person_id,
			String person_type, String inj_permenant_disablity, String inj_treatment, String inj_convenance,
			String inj_special_diet, String inj_cost_nursing_attendant, String inj_cost_artificial_limp,
			String inj_loss_erning_capacity, String inj_loss_income, String inj_any_other_loss,
			String inj_com_mental_phy_shock, String inj_pain_suffering, String inj_loss_amenities,
			String inj_loss_ear_inc_har_dis, String inj_total_copensation, String inj_disfiguration,
			String inj_medical_treatment, String inj_loss_of_marriage, String inj_natureofinjury,
			String inj_typeofinjury, String inj_expenditure_treatment, String inj_permenant_disablity_details,
			String token, String inj_income, String version) {
		super();
		this.id_insurance = id_insurance;
		this.vehicle_id = vehicle_id;
		this.accident_id = accident_id;
